...
Assert-Contains $speciesConstants "SPECIES_INFIORALA,`n    SPECIES_GHEPIO,`n    SPECIES_TINUNCOL,`n    SPECIES_PEREGRINUS,`n    SPECIES_GAZZUOLA,`n    SPECIES_BRILLAZZA,`n    SPECIES_GAZZOMBRA,`n    SPECIES_MOLOSPSY,`n    SPECIES_LENGHELIS,`n    SPECIES_CUSTOM_END," 'Species append-only sequence'
...
Assert-Contains $dexConstants "NATIONAL_DEX_INFIORALA,`n    NATIONAL_DEX_GHEPIO,`n    NATIONAL_DEX_TINUNCOL,`n    NATIONAL_DEX_PEREGRINUS,`n    NATIONAL_DEX_GAZZUOLA,`n    NATIONAL_DEX_BRILLAZZA,`n    NATIONAL_DEX_GAZZOMBRA,`n    NATIONAL_DEX_MOLOSPSY,`n    NATIONAL_DEX_LENGHELIS," 'Pokedex append-only sequence'
