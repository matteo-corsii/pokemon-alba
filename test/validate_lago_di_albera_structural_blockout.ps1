...
Assert-True (@($map.connections | Where-Object { $_.direction -eq 'up' -and $_.map -eq 'MAP_BORGO_DI_CASTELLO' -and [int]$_.offset -eq 87 }).Count -eq 1) 'Lago Borgo connection is incorrect.'
