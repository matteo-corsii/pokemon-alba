...
TEST("Ausonia starter IDs are append-only and distinct")
{
    ...
    EXPECT_EQ(SPECIES_LENGHELIS, SPECIES_MOLOSPSY + 1);
    EXPECT_EQ(SPECIES_LUSCINCO, SPECIES_LENGHELIS + 1);
    EXPECT_EQ(SPECIES_LUSCERP, SPECIES_LUSCINCO + 1);
    EXPECT_EQ(SPECIES_LUMELLA, SPECIES_LUSCERP + 1);
    EXPECT_EQ(SPECIES_OMPHALUX, SPECIES_LUMELLA + 1);
    EXPECT_EQ(SPECIES_PALUDIX, SPECIES_OMPHALUX + 1);
    EXPECT_EQ(SPECIES_SANGUILEX, SPECIES_PALUDIX + 1);
    EXPECT_EQ(SPECIES_TRITINO, SPECIES_SANGUILEX + 1);
    EXPECT_EQ(SPECIES_TRICREST, SPECIES_TRITINO + 1);
    EXPECT_EQ(SPECIES_SALAMPOLLA, SPECIES_TRICREST + 1);
    EXPECT_EQ(SPECIES_ALCHIMANDRA, SPECIES_SALAMPOLLA + 1);
    EXPECT_EQ(SPECIES_CISTERNIDE, SPECIES_ALCHIMANDRA + 1);
    EXPECT_EQ(SPECIES_CALCISTERN, SPECIES_CISTERNIDE + 1);
    EXPECT_EQ(SPECIES_EGG, SPECIES_CALCISTERN + 1);
    ...
    EXPECT_EQ(NATIONAL_DEX_LENGHELIS, NATIONAL_DEX_MOLOSPSY + 1);
    EXPECT_EQ(NATIONAL_DEX_LUSCINCO, NATIONAL_DEX_LENGHELIS + 1);
    EXPECT_EQ(NATIONAL_DEX_LUSCERP, NATIONAL_DEX_LUSCINCO + 1);
    EXPECT_EQ(NATIONAL_DEX_LUMELLA, NATIONAL_DEX_LUSCERP + 1);
    EXPECT_EQ(NATIONAL_DEX_OMPHALUX, NATIONAL_DEX_LUMELLA + 1);
    EXPECT_EQ(NATIONAL_DEX_PALUDIX, NATIONAL_DEX_OMPHALUX + 1);
    EXPECT_EQ(NATIONAL_DEX_SANGUILEX, NATIONAL_DEX_PALUDIX + 1);
    EXPECT_EQ(NATIONAL_DEX_TRITINO, NATIONAL_DEX_SANGUILEX + 1);
    EXPECT_EQ(NATIONAL_DEX_TRICREST, NATIONAL_DEX_TRITINO + 1);
    EXPECT_EQ(NATIONAL_DEX_SALAMPOLLA, NATIONAL_DEX_TRICREST + 1);
    EXPECT_EQ(NATIONAL_DEX_ALCHIMANDRA, NATIONAL_DEX_SALAMPOLLA + 1);
    EXPECT_EQ(NATIONAL_DEX_CISTERNIDE, NATIONAL_DEX_ALCHIMANDRA + 1);
    EXPECT_EQ(NATIONAL_DEX_CALCISTERN, NATIONAL_DEX_CISTERNIDE + 1);
    EXPECT_EQ(NATIONAL_DEX_COUNT, NATIONAL_DEX_CALCISTERN);
    ...
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_LENGHELIS), COMPOUND_STRING("Lenghelis")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_LUSCINCO), COMPOUND_STRING("Luscinco")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_LUSCERP), COMPOUND_STRING("Luscerp")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_LUMELLA), COMPOUND_STRING("Lumella")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_OMPHALUX), COMPOUND_STRING("Omphalux")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_PALUDIX), COMPOUND_STRING("Paludix")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_SANGUILEX), COMPOUND_STRING("Sanguilex")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_TRITINO), COMPOUND_STRING("Tritino")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_TRICREST), COMPOUND_STRING("Tricrest")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_SALAMPOLLA), COMPOUND_STRING("Salampolla")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_ALCHIMANDRA), COMPOUND_STRING("Alchimandra")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_CISTERNIDE), COMPOUND_STRING("Cisternide")), 0);
    EXPECT_EQ(StringCompare(GetSpeciesName(SPECIES_CALCISTERN), COMPOUND_STRING("Calcistern")), 0);
}
