...
Assert-True $sp.Contains("SPECIES_LUSCERP,`n    SPECIES_LUMELLA,`n    SPECIES_OMPHALUX,`n    SPECIES_PALUDIX,`n    SPECIES_SANGUILEX,`n    SPECIES_CUSTOM_END,") 'Species order/count mismatch'
Assert-True $dex.Contains("NATIONAL_DEX_LUSCERP,`n    NATIONAL_DEX_LUMELLA,`n    NATIONAL_DEX_OMPHALUX,`n    NATIONAL_DEX_PALUDIX,`n    NATIONAL_DEX_SANGUILEX,") 'National Dex order mismatch'
Assert-True $dex.Contains('#define NATIONAL_DEX_COUNT  NATIONAL_DEX_SANGUILEX') 'National Dex count mismatch'
$checks=@{
