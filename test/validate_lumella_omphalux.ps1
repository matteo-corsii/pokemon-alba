...
Assert-True $sp.Contains("SPECIES_LUSCERP,`n    SPECIES_LUMELLA,`n    SPECIES_OMPHALUX,`n    SPECIES_PALUDIX,`n    SPECIES_SANGUILEX,`n    SPECIES_TRITINO,`n    SPECIES_TRICREST,`n    SPECIES_SALAMPOLLA,`n    SPECIES_ALCHIMANDRA,`n    SPECIES_CUSTOM_END,") 'Species order/count mismatch'
...
Assert-True $dex.Contains('#define NATIONAL_DEX_COUNT  NATIONAL_DEX_ALCHIMANDRA') 'National Dex count mismatch'
$checks=@{
