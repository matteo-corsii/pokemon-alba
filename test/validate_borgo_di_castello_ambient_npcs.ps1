...
$expected = @(
    ...
    @('LOCALID_BORGO_DI_CASTELLO_RESIDENTE_VICOLI', 'OBJ_EVENT_GFX_WOMAN_1', 29, 35, 'MOVEMENT_TYPE_FACE_DOWN'),
    @('LOCALID_BORGO_DI_CASTELLO_VIAGGIATORE_LARICIA', 'OBJ_EVENT_GFX_HIKER', 52, 51, 'MOVEMENT_TYPE_FACE_LEFT'),
    @('LOCALID_BORGO_DI_CASTELLO_BAMBINO', 'OBJ_EVENT_GFX_BOY_1', 16, 46, 'MOVEMENT_TYPE_FACE_DOWN'),
    @('LOCALID_BORGO_DI_CASTELLO_DONNA_VILLA', 'OBJ_EVENT_GFX_WOMAN_2', 20, 10, 'MOVEMENT_TYPE_FACE_RIGHT'),
    @('LOCALID_BORGO_DI_CASTELLO_VIAGGIATORE_PIAZZA', 'OBJ_EVENT_GFX_GENTLEMAN', 33, 15, 'MOVEMENT_TYPE_FACE_LEFT'),
    @('LOCALID_BORGO_DI_CASTELLO_ABITANTE_FONTANA', 'OBJ_EVENT_GFX_MAN_5', 29, 14, 'MOVEMENT_TYPE_FACE_DOWN')
)
