...
A ($inf.Contains('Vive in branchi presso rive e pontili.\n') -and $inf.Contains('Le scaglie circolari riflettono la luce.\n') -and $inf.Contains("Così si orienta nell'acqua torbida.") -and $inf.Contains('lasciando emergere') -and $inf.Contains('navi romane') -and $inf.Contains('placche dorsali')) 'Canonical descriptions incomplete'
