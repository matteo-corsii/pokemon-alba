...
A ($inf.Contains('Vive in branchi presso rive e pontili.') -and $inf.Contains('scaglie\ncircolari riflettono la luce, così non si perde') -and $inf.Contains('lasciando emergere') -and $inf.Contains('navi romane') -and $inf.Contains('placche dorsali')) 'Canonical descriptions incomplete'
