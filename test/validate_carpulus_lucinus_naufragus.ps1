...
A ($inf.Contains('scaglie circolari') -and $inf.Contains('lasciando emergere') -and $inf.Contains('navi romane') -and $inf.Contains('placche dorsali')) 'Canonical descriptions incomplete'
