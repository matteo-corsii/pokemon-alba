...
$allowed=@('graphics/pokemon/icon_palettes/pal6.pal','src/graphics.c','src/pokemon_icon.c','src/pokemon_storage_system.c','src/data/graphics/pokemon.h','src/data/pokemon/species_info.h','test/species.c','test/validate_early_ausonia_fauna_batch_d.ps1','test/validate_early_ausonia_graphics_batch_d.ps1','test/validate_molospsy.ps1','graphics/pokemon/molospsy/anim_front.png','graphics/pokemon/molospsy/back.png','graphics/pokemon/molospsy/icon.png','graphics/pokemon/molospsy/normal.pal','graphics/pokemon/molospsy/shiny.pal')
...
& git -C $RepositoryRoot diff --quiet develop -- include/global.h include/constants/pokedex.h src/pokedex.c src/new_game.c src/overworld.c test/save.c
