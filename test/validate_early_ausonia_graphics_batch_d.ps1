...
$allowed=@('graphics/pokemon/icon_palettes/pal6.pal','src/graphics.c','src/pokemon_icon.c','src/pokemon_storage_system.c','src/data/graphics/pokemon.h','src/data/pokemon/species_info.h','src/data/pokemon/all_learnables.json','src/data/pokemon/egg_moves.h','src/data/pokemon/pokedex_orders.h','include/constants/species.h','include/constants/pokedex.h','test/species.c','test/validate_early_ausonia_fauna_batch_b.ps1','test/validate_early_ausonia_fauna_batch_c.ps1','test/validate_early_ausonia_fauna_batch_d.ps1','test/validate_early_ausonia_graphics_batch_a.ps1','test/validate_early_ausonia_graphics_batch_b.ps1','test/validate_early_ausonia_graphics_batch_c.ps1','test/validate_early_ausonia_graphics_batch_d.ps1','test/validate_molospsy.ps1','test/validate_lenghelis.ps1','test/validate_luscinco_luscerp.ps1','test/validate_albera_storica_secret_base_mentor.ps1','docs/AUSONIA_REGIONAL_DEX_PLAN.md','graphics/pokemon/molospsy/anim_front.png','graphics/pokemon/molospsy/back.png','graphics/pokemon/molospsy/icon.png','graphics/pokemon/molospsy/normal.pal','graphics/pokemon/molospsy/shiny.pal','graphics/pokemon/lenghelis/anim_front.png','graphics/pokemon/lenghelis/back.png','graphics/pokemon/lenghelis/icon.png','graphics/pokemon/lenghelis/normal.pal','graphics/pokemon/lenghelis/shiny.pal','graphics/pokemon/luscinco/anim_front.png','graphics/pokemon/luscinco/back.png','graphics/pokemon/luscinco/icon.png','graphics/pokemon/luscinco/normal.pal','graphics/pokemon/luscinco/shiny.pal','graphics/pokemon/luscerp/anim_front.png','graphics/pokemon/luscerp/back.png','graphics/pokemon/luscerp/icon.png','graphics/pokemon/luscerp/normal.pal','graphics/pokemon/luscerp/shiny.pal')
