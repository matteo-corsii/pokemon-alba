...
& git -C $RepositoryRoot diff --quiet develop -- include/global.h include/constants/pokedex.h include/pokedex.h src/pokedex.c src/new_game.c src/overworld.c test/save.c
