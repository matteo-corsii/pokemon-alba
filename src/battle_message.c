...
static const u8 sText_WildPkmnAppeared[] = _("È apparso {B_OPPONENT_MON1_NAME} selvatico!\p");
...
static const u8 sText_PkmnComeBack[] = _("Rientra, {B_BUFF1}!");
...
static const u8 sText_WildPkmnSuffix[] = _(" selvatico");
static const u8 sText_FoePkmnSuffix[] = _(" avversario");
...
static const u8 sText_SpAttack[] = _("ATT. SPECIALE");
static const u8 sText_SpDefense[] = _("DIF. SPECIALE");
...
const u8 gText_severely[] = _(" drasticamente");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1} guadagna{B_BUFF2} {B_BUFF3} Punti ESP.!\p"),
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{B_BUFF1} sale al livello {B_BUFF2}!{WAIT_SE}\p"),
    [STRINGID_PKMNLEARNEDMOVE]                      = COMPOUND_STRING("{B_BUFF1} ha imparato\n{B_BUFF2}!{WAIT_SE}\p"),
    [STRINGID_TRYTOLEARNMOVE1]                      = COMPOUND_STRING("{B_BUFF1} sta cercando di\nimparare {B_BUFF2}.\p"),
    [STRINGID_TRYTOLEARNMOVE2]                      = COMPOUND_STRING("Ma {B_BUFF1} conosce già\nquattro mosse.\p"),
    [STRINGID_TRYTOLEARNMOVE3]                      = COMPOUND_STRING("Vuoi fargli dimenticare una mossa\ne insegnargli {B_BUFF2}?"),
    [STRINGID_PKMNFORGOTMOVE]                       = COMPOUND_STRING("{B_BUFF1} ha dimenticato\n{B_BUFF2}…\p"),
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}Vuoi rinunciare a insegnare\n{B_BUFF2} a {B_BUFF1}?"),
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{B_BUFF1} non ha imparato\n{B_BUFF2}.\p"),
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("Non hai più POKéMON\nin grado di lottare!\p"),
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("Hai perso ¥{B_BUFF1}…"),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("Hai dato ¥{B_BUFF1}\nal vincitore…"),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("Hai perso i sensi…"),
    ...
    [STRINGID_PKMNHURTBYPOISON]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} soffre per\nl'avvelenamento!"),
    ...
    [STRINGID_PKMNHURTBYBURN]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} soffre per\nla scottatura!"),
    ...
    [STRINGID_STATSWONTINCREASE]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}: {B_BUFF1}\nnon può aumentare oltre!"),
    [STRINGID_STATSWONTDECREASE]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}: {B_BUFF1}\nnon può diminuire oltre!"),
    ...
    [STRINGID_STATROSE]                             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}: {B_BUFF1}\naumenta{B_BUFF2}!"),
    [STRINGID_STATFELL]                             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}: {B_BUFF1}\ndiminuisce{B_BUFF2}!"),
    ...
    [STRINGID_NORUNNINGFROMTRAINERS]                = COMPOUND_STRING("No! Non puoi fuggire da una lotta con un Allenatore!\p"),
    [STRINGID_CANTESCAPE]                           = COMPOUND_STRING("Non puoi fuggire!\p"),
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("PROF. LAURO: Non lasciarmi così!\p"), //no decapitalize until it is everywhere
    ...
    [STRINGID_ATTACKERCANTESCAPE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} non riesce a fuggire!"),
    ...
    [STRINGID_TARGETABILITYSTATRAISE]               = COMPOUND_STRING("{B_DEF_ABILITY}:\n{B_DEF_NAME_WITH_PREFIX}\l{B_BUFF1} aumenta{B_BUFF2}!"), // Not in Gen 5+
    [STRINGID_STATWASMAXEDOUT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}: {B_BUFF1}\nraggiunge il massimo!"),
    [STRINGID_ATTACKERABILITYSTATRAISE]             = COMPOUND_STRING("{B_ATK_ABILITY}:\n{B_ATK_NAME_WITH_PREFIX}\l{B_BUFF1} aumenta{B_BUFF2}!"), // Not in Gen 5+
    ...
    [STRINGID_TARGETABILITYSTATLOWER]               = COMPOUND_STRING("{B_DEF_ABILITY}:\n{B_DEF_NAME_WITH_PREFIX}\l{B_BUFF1} diminuisce{B_BUFF2}!"), // Not in Gen 5+
    ...
    [STRINGID_SCRIPTINGABILITYSTATRAISE]            = COMPOUND_STRING("{B_SCR_ABILITY}:\n{B_SCR_NAME_WITH_PREFIX}\l{B_BUFF1} aumenta{B_BUFF2}!"),
    ...
    [STRINGID_ITEMRESTOREDSPECIESHEALTH]            = COMPOUND_STRING("{B_BUFF1} recupera PS."),
