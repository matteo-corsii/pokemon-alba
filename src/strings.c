...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("NICO");
const u8 gText_ExpandedPlaceholder_May[] = _("LIA");
...
const u8 gText_ThisIsAPokemon[] = _("Questa creatura si chiama POKéMON.{PAUSE 96}\p");
...
const u8 gText_BirchInTrouble[] = _("Il PROF. LAURO è in pericolo!\nScegli un POKéMON e salvalo!");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_KEY_ITEMS]  = COMPOUND_STRING("STR. BASE")
};
...
const u8 gText_ThatItemIsSoldOut[] = _("Mi dispiace, ma l'articolo è esaurito.{PAUSE_UNTIL_PRESS}");
const u8 gText_SoldOut[] = _("ESAURITO");
const u8 gText_InBagVar1[] = _("NELLA BORSA: {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Smetti di fare acquisti.");
const u8 gText_Var1CertainlyHowMany[] = _("{STR_VAR_1}? Certamente.\nQuanti ne vuoi?");
const u8 gText_Var1CertainlyHowMany2[] = _("{STR_VAR_1}? Certamente.\nQuanti ne vuoi?");
const u8 gText_Var1AndYouWantedVar2[] = _("{STR_VAR_1}? Ne vuoi {STR_VAR_2}?\nIl totale è ¥{STR_VAR_3}.");
const u8 gText_Var1IsItThatllBeVar2[] = _("{STR_VAR_1}, giusto?\nCosta ¥{STR_VAR_2}. Lo vuoi?");
const u8 gText_YouWantedVar1ThatllBeVar2[] = _("Vuoi {STR_VAR_1}?\nCosta ¥{STR_VAR_2}. Va bene?");
const u8 gText_HereYouGoThankYou[] = _("Ecco a te!\nGrazie mille.");
const u8 gText_ThankYouIllSendItHome[] = _("Grazie!\nLo invierò al PC di casa.");
const u8 gText_ThanksIllSendItHome[] = _("Grazie!\nLo invierò al tuo PC di casa.");
const u8 gText_YouDontHaveMoney[] = _("Non hai abbastanza denaro.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomForThis[] = _("Non hai più spazio per questo\nstrumento.{PAUSE_UNTIL_PRESS}");
const u8 gText_SpaceForVar1Full[] = _("Lo spazio per {STR_VAR_1} è esaurito.{PAUSE_UNTIL_PRESS}");
const u8 gText_AnythingElseICanHelp[] = _("C'è altro che posso fare\nper te?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Posso aiutarti in altro?");
const u8 gText_ThrowInPremierBall[] = _("Aggiungo anche una PREMIER BALL.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("Aggiungo anche {STR_VAR_1} PREMIER BALL.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ICanPayVar1[] = _("Posso offrirti ¥{STR_VAR_1}.\nVa bene?");
const u8 gText_TurnedOverVar1ForVar2[] = _("Hai ceduto {STR_VAR_2}\ne ricevuto ¥{STR_VAR_1}.");
...
const u8 gText_PkmnCantSwitchOut[] = _("Non puoi sostituire\n{STR_VAR_1}!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyInBattle[] = _("{STR_VAR_1} è già\nin lotta!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadySelected[] = _("Hai già selezionato\n{STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHasNoEnergy[] = _("{STR_VAR_1} non ha energie\nper lottare!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SendMailToPC[] = _("Inviare la POSTA rimossa\nal PC?");
const u8 gText_MailSentToPC[] = _("La POSTA è stata inviata al PC.{PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("La CASELLA POSTALE del PC è piena.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailMessageWillBeLost[] = _("Rimuovendo la POSTA, il\nmessaggio andrà perso. Va bene?");
const u8 gText_RemoveMailBeforeItem[] = _("Rimuovi la POSTA prima\ndi dare uno strumento.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnWasGivenItem[] = _("{STR_VAR_1} ora tiene\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnAlreadyHoldingItemSwitch[] = _("{STR_VAR_1} tiene già\n{STR_VAR_2}.\pVuoi scambiare i due\nstrumenti?");
...
const u8 gText_MailTakenFromPkmn[] = _("Hai preso la POSTA dal\nPOKéMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_SwitchedPkmnItem[] = _("Hai preso {STR_VAR_2} e dato\n{STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("Il POKéMON tiene già uno\nstrumento e non può tenere POSTA.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailTransferredFromMailbox[] = _("La POSTA è stata trasferita\ndalla CASELLA POSTALE.{PAUSE_UNTIL_PRESS}");
const u8 gText_BagFullCouldNotRemoveItem[] = _("La BORSA è piena. Impossibile\nprendere lo strumento.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveToWhere[] = _("Spostare dove?");
const u8 gText_TeachWhichPokemon[] = _("Teach which POKéMON?");
const u8 gText_UseOnWhichPokemon[] = _("Su quale POKéMON?");
const u8 gText_GiveToWhichPokemon[] = _("A quale POKéMON vuoi darlo?");
const u8 gText_DoWhatWithPokemon[] = _("Cosa vuoi fare con questo {PKMN}?");
const u8 gText_NothingToCut[] = _("Non c'è nulla da tagliare.");
const u8 gText_CantSurfHere[] = _("Non puoi surfare qui.");
const u8 gText_AlreadySurfing[] = _("Stai già surfando.");
const u8 gText_CantUseHere[] = _("Non puoi usarlo qui.");
const u8 gText_RestoreWhichMove[] = _("Quale mossa vuoi ripristinare?");
const u8 gText_BoostPp[] = _("A quale mossa aumentare i PP?");
const u8 gText_DoWhatWithItem[] = _("Cosa vuoi fare con lo strumento?");
const u8 gText_NoPokemonForBattle[] = _("Non hai POKéMON per lottare!");
...
const u8 gText_DoWhatWithMail[] = _("Cosa vuoi fare con la POSTA?");
...
const u8 gText_MoveItemWhere[] = _("Dove vuoi spostare lo strumento?");
...
const u8 gText_NoUse[] = _("NON PUÒ");
const u8 gText_Able[] = _("PUÒ");
const u8 gText_First_PM[] = _("PRIMO");
const u8 gText_Second_PM[] = _("SECONDO");
const u8 gText_Third_PM[] = _("TERZO");
const u8 gText_Able2[] = _("PUÒ");
const u8 gText_NotAble[] = _("NON PUÒ");
const u8 gText_Able3[] = _("PUÒ!");
const u8 gText_NotAble2[] = _("NON PUÒ!");
const u8 gText_Learned[] = _("IMPARATA");
const u8 gText_Have[] = _("PRESENTE");
const u8 gText_DontHave[] = _("ASSENTE");
...
const u8 gText_Accuracy2[] = _("PREC.");
...
const u8 gText_OddEggFoundByCouple[] = _("Uno strano UOVO POKéMON\ntrovato dai gestori Pensione.");
const u8 gText_PeculiarEggNicePlace[] = _("Uno strano UOVO POKéMON\nricevuto in un bel posto.");
const u8 gText_PeculiarEggTrade[] = _("Uno strano UOVO POKéMON\nottenuto con uno scambio.");
const u8 gText_EggFromHotSprings[] = _("Un UOVO POKéMON ottenuto\nalle sorgenti termali.");
const u8 gText_EggFromTraveler[] = _("Uno strano UOVO POKéMON\nricevuto da un viaggiatore.");
...
const u8 gText_MenuOptionBag[] = _("BORSA");
...
const u8 gText_SaveFailedCheckingBackup[] = _("Salvataggio fallito.\nControllo memoria di backup…\n{COLOR RED}“Attendi circa 1 minuto”");
const u8 gText_BackupMemoryDamaged[] = _("Memoria di backup danneggiata o\nbatteria interna scarica.\nPuoi giocare, ma non salvare.");
const u8 gText_GamePlayCannotBeContinued[] = _("{COLOR RED}“Impossibile continuare a giocare.\nRitorno alla schermata del titolo…”");
const u8 gText_CheckCompleted[] = _("Controllo completato.\nNuovo tentativo di salvataggio.\nAttendi.");
const u8 gText_SaveCompleteGameCannotContinue[] = _("Salvataggio completato.\n{COLOR RED}“Impossibile continuare a giocare.\nRitorno alla schermata del titolo.”");
...
const u8 gText_MenuBag[] = _("BORSA");
...
const u8 gText_IsThisTheCorrectTime[] = _("Questa è l'ora corretta?");
const u8 gText_Confirm3[] = _("SALVA");
