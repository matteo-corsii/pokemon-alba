...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_NO_POKEMON]             = COMPOUND_STRING("Non hai POKéMON."),
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_SWITCH]          = {COMPOUND_STRING("SPOSTA"),          CursorCb_Switch},
    [MENU_CANCEL1]         = {gText_Cancel2,                      CursorCb_Cancel1},
    [MENU_ITEM]            = {COMPOUND_STRING("STRUMENTO"),       CursorCb_Item},
