...
Cingerm, Serbrace e Ardeino sostituiscono rispettivamente Treecko, Torchic e Mudkip nei soli tre slot starter Emerald. La selezione avviene nel Laboratorio del Cratere e crea la forma base scelta al livello 5 attraverso il normale flusso `GetStarterPokemon`/`ScriptGiveMon`; lo stato narrativo del laboratorio fa ritornare lo selector allo script senza avviare la vecchia battaglia selvaggia di Route 101. Natura, sesso, IV, statistiche e mosse iniziali restano affidati al motore. Bulbasaur, Charmander e Squirtle restano invariati nelle configurazioni FireRed e LeafGreen.

La distribuzione iniziale è deterministica: il giocatore riceve la specie scelta, Nico quella avvantaggiata e Lia la rimanente. Le tre squadre iniziali maschili già collegate agli slot Treecko, Torchic e Mudkip forniscono a Nico rispettivamente Serbrace, Ardeino e Cingerm; Lia non possiede una battaglia in questa milestone. I rami successivi già registrati restano disponibili per lo sviluppo futuro, ma Route 103 non ripete la sfida introduttiva. Le forme base non compaiono in incontri selvatici, regali aggiuntivi, commerci, Uova o strumenti di debug. La selezione manuale del sesso resta rinviata.
