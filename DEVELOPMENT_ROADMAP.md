...
**Stato delle milestone:** Albèra/prologo v1 è conclusa. La prima registrazione dati delle nove specie starter di Ausonia è completata; Cingerm, Serbrace e Ardeino formano ora il trio selezionabile in Emerald, con FireRed e LeafGreen invariati. Tutte e tre le forme base possiedono front, back, icona e palette normale originali; shiny, cry, impronte, overworld e grafica delle evoluzioni non sono ancora definitivi. Le 46 mosse uniche dei nove learnset per livello sono state sottoposte ad audit e localizzate dove ancora inglesi, senza cambiare dati tecnici o learnset. Abilità, Nature e Memo Allenatore del riepilogo sono stati localizzati per il prototipo.
...
**Stato:** le linee Cingerm, Serbrace e Ardeino sono registrate come prototipi dati. Le tre forme base sono ottenibili soltanto nei rispettivi slot starter Emerald e gli stadi evoluti soltanto tramite evoluzione o nelle squadre previste di Nico e Lia; nessuna delle nove specie compare negli incontri selvatici. Cingerm, Serbrace e Ardeino usano grafica base originale con shiny, cry, impronta, overworld e ombra ancora provvisori. Le evoluzioni conservano i segnaposto documentati. I learnset restano invariati; le relative mosse per livello mostrano ora nome e descrizione italiani quando erano ancora inglesi.
