...
// Via dei Cisternoni's tree reuses the Tree1 interior.
#define SECRET_BASE_CISTERNONI_TREE_1 252

#define SECRET_BASE_CISTERNONI_TREE SECRET_BASE_GROUP(25)

// Lago di Albera's rock entrances reuse the Blue Cave 1 interior.
#define SECRET_BASE_LAGO_DI_ALBERA_ROCK_NORTH 84
#define SECRET_BASE_LAGO_DI_ALBERA_ROCK_SOUTH 85

#define NUM_SECRET_BASE_GROUPS 26
