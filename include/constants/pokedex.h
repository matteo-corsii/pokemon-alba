...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_CINGERM,
    NATIONAL_DEX_ROVASCO,
    NATIONAL_DEX_SELVAZANNA,
    NATIONAL_DEX_SERBRACE,
    NATIONAL_DEX_VIPERCEN,
    NATIONAL_DEX_TOSSIVAMPA,
    NATIONAL_DEX_ARDEINO,
    NATIONAL_DEX_VELAIRONE,
    NATIONAL_DEX_CODAIRONE,
    NATIONAL_DEX_BORGOTTO,
    ...
    NATIONAL_DEX_GHEPIO,
    NATIONAL_DEX_TINUNCOL,
    NATIONAL_DEX_PEREGRINUS,
    NATIONAL_DEX_GAZZUOLA,
    NATIONAL_DEX_BRILLAZZA,
    NATIONAL_DEX_GAZZOMBRA,
    NATIONAL_DEX_MOLOSPSY,
    NATIONAL_DEX_LENGHELIS,
    NATIONAL_DEX_LUSCINCO,
    NATIONAL_DEX_LUSCERP,
    NATIONAL_DEX_LUMELLA,
    NATIONAL_DEX_OMPHALUX,
    NATIONAL_DEX_PALUDIX,
    NATIONAL_DEX_SANGUILEX,
    NATIONAL_DEX_TRITINO,
    NATIONAL_DEX_TRICREST,
    NATIONAL_DEX_SALAMPOLLA,
    NATIONAL_DEX_ALCHIMANDRA,
    NATIONAL_DEX_CISTERNIDE,
    NATIONAL_DEX_CALCISTERN,
    NATIONAL_DEX_CARPULUS,
    NATIONAL_DEX_LUCINUS,
    NATIONAL_DEX_NAUFRAGUS,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_NAUFRAGUS
