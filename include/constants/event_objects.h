...
enum
{
    ...
    OBJ_EVENT_GFX_CINGERM,
    OBJ_EVENT_GFX_ARDEINO,
    OBJ_EVENT_GFX_SERBRACE,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_CINGERM                 0x1134
#define OBJ_EVENT_PAL_TAG_ARDEINO                 0x1135
#define OBJ_EVENT_PAL_TAG_SERBRACE                0x1136
